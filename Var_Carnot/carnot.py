...
from heatengine import HeatEngineEnv

"""
Slightly modified version of the Carnot Heat Engine environment 
Original code can be found: https://github.com/CLEANit/heatenginegym
"""
